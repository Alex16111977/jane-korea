/**
 * Miso: 한국어 수업 — Разговорные фразы для реальных ситуаций в Корее
    ...
    situations: [
        ...
        // =====================================================
        {
            ...
            phrases: [
                ...
                {
                    korean: '독일까지 얼마예요?',
                    romanization: 'dogilkkaji eolmayeyo?',
                    translation: 'Сколько стоит до Германии?',
            ...
            dialogue: {
                title: 'Мини-диалог: отправка посылки в Германию',
                lines: [
                    { speaker: '손님', korean: '안녕하세요. 이 소포를 독일에 보내고 싶어요.', translation: 'Здравствуйте. Хочу отправить эту посылку в Германию.' },
