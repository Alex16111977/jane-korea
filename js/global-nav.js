...
(function() {
    ...
    var SEARCH_DATA = [
        ...
        { t: 'Упражнения по грамматике', u: 'exercises.html', k: 'упражнения задания практика ключи самоучитель тренажёр exercises падежи причастия косвенная речь приветствие еда семья дом распорядок дня разговорные темы' },
        ...
        { t: 'Словарь: В парикмахерской 미용실', u: 'vocabulary/hairstyle/index.html', k: 'парикмахерская причёска волосы стрижка 머리를 자르다 파마하다 염색하다 커트 머리 층을 내다 салон' },
        { t: 'Словарь: Корейские праздники 명절', u: 'vocabulary/holidays/index.html', k: 'праздники обычаи 설날 추석 정월대보름 단오 세배 차례 윷놀이 세뱃돈 명절 традиции' },
        { t: 'Словарь: Планируем поездку 여행 계획', u: 'vocabulary/trip_planning/index.html', k: 'путешествие поездка тур 배낭여행 패키지여행 성수기 비수기 숙박비 펜션 민박 отпуск жильё расходы' },
        { t: 'Словарь: Отношения и брак 연애와 결혼', u: 'vocabulary/marriage/index.html', k: 'отношения любовь брак свадьба 소개팅 선을 보다 짝사랑 청혼하다 약혼 결혼 배우자 знакомство' },
        { t: 'Словарь: Происшествия и аварии 사건과 사고', u: 'vocabulary/accidents/index.html', k: 'происшествия авария пожар новости 화재 도둑 소매치기 부상 사망 피동 пассив 잡히다 열리다' },
        ...
        { t: 'Одновременные действия -면서', u: 'lesson_47_simultaneous_actions/index.html', k: 'одновременные действия -면서 simultaneous actions' },
        { t: 'После действия -은/ㄴ 후에', u: 'lesson_48_after_action/index.html', k: 'после действия -은/ㄴ 후에 after action' },
        { t: 'Перед действием -기 전에', u: 'lesson_50_before_action/index.html', k: 'перед действием -기 전에 before action' },
        { t: 'Формальное "после" -고 나서 / -은 다음에', u: 'lesson_51_after_formal/index.html', k: 'формальное после -고 나서 -은 다음에 after formal' },
        { t: 'Инструментальный 로/으로', u: 'lesson_53_instrumental_ro/index.html', k: 'инструментальный 로/으로 instrumental ro' },
        { t: 'Почтительная частица -(으)시-', u: 'lesson_55_honorific_si/index.html', k: 'почтительная частица -(으)시- honorific si' },
        { t: 'Противопоставление -지만', u: 'lesson_56_contrast_jiman/index.html', k: 'противопоставление -지만 contrast jiman' },
        { t: 'Конструкции -는 대로', u: 'lesson_84_constructions_neun_daero/index.html', k: 'конструкции -는 대로 constructions neun daero' },
        { t: 'Условное -다면', u: 'lesson_85_conditional_damyeon/index.html', k: 'условное -다면 conditional damyeon' },
        { t: 'Временные конструкции', u: 'lesson_86_time_constructions/index.html', k: 'временные конструкции time constructions' },
        { t: 'Предположение -(으)ㄹ 것 같다', u: 'lesson_95_assumption_geot_gatda/index.html', k: 'предположение -(으)ㄹ 같다 assumption geot gatda' },
        { t: 'Скорее да, чем нет -는/(으)ㄴ 편이다', u: 'lesson_96_tendency_pyeonida/index.html', k: 'скорее -는/(으)ㄴ 편이다 tendency pyeonida' },
        { t: 'Достаточно сделать -(으)면 되다', u: 'lesson_97_solution_myeon_doeda/index.html', k: 'достаточно сделать -(으)면 되다 solution myeon doeda' },
        { t: 'Вообще-то да, но… -기는 하다', u: 'lesson_98_concession_gineun_hada/index.html', k: 'вообще -기는 하다 concession gineun hada' },
        { t: 'Ну что вы! -기는요', u: 'lesson_99_modesty_gineunyo/index.html', k: '-기는요 modesty gineunyo' },
        { t: 'Что угодно, когда угодно -(이)든지', u: 'lesson_100_any_deunji/index.html', k: 'угодно когда угодно -(이)든지 any deunji' },
        { t: 'Становиться кем-то -이/가 되다', u: 'lesson_101_becoming_i_ga_doeda/index.html', k: 'становиться -이/가 되다 becoming i ga doeda' },
        { t: 'Ничего и никто — 아무 -도', u: 'lesson_102_nothing_amu_do/index.html', k: 'ничего никто 아무 -도 nothing amu do' },
        { t: 'Цена и сумма: -짜리 и -어치', u: 'lesson_103_price_jjari_eochi/index.html', k: 'цена сумма -짜리 -어치 price jjari eochi' },
        { t: 'Личное наблюдение -더라고요 · -던데요', u: 'lesson_105_retrospective_deoragoyo/index.html', k: 'личное наблюдение -더라고요 -던데요 retrospective deoragoyo' },
        { t: 'Повод для действия -길래', u: 'lesson_106_cause_gillae/index.html', k: 'повод действия -길래 cause gillae' },
        { t: 'Общее знание -잖아요', u: 'lesson_107_shared_knowledge_janayo/index.html', k: 'общее знание -잖아요 shared knowledge janayo' },
        { t: 'Слухи и упрёк -다면서요 · -라면서요', u: 'lesson_108_hearsay_damyeonseo/index.html', k: 'слухи упрёк -다면서요 -라면서요 hearsay damyeonseo' },
        { t: 'Отглагольные послелоги 대하여 · 위하여 · 통하여', u: 'lesson_109_verbal_postpositions/index.html', k: 'отглагольные послелоги 대하여 위하여 통하여 verbal postpositions' },
        { t: 'Именные прилагательные -적 и словообразование', u: 'lesson_110_adjective_derivation/index.html', k: 'именные прилагательные словообразование -적 adjective derivation' },
        { t: 'Правдоподобие -(으)ㄹ 법하다 · -(으)ㄹ 성싶다', u: 'lesson_111_probability_beophada/index.html', k: 'правдоподобие -(으)ㄹ 법하다 -(으)ㄹ 성싶다 probability beophada' },
        { t: 'Ситуация -는 마당에 · -는 차에', u: 'lesson_112_situation_madang_cha/index.html', k: 'ситуация -는 마당에 -는 차에 situation madang cha' },
        { t: 'Официальное время -기에 앞서 · -는 데 있어', u: 'lesson_113_formal_time_apseo/index.html', k: 'официальное время -기에 앞서 -는 있어 formal time apseo' },
        { t: 'Принижение -에 불과하다 · -느니만 못하다', u: 'lesson_114_belittling_bulgwahada/index.html', k: 'принижение -에 불과하다 -느니만 못하다 belittling bulgwahada' },
        { t: 'Крайняя степень -기 그지없다 · -기 짝이 없다', u: 'lesson_115_extreme_geujieopda/index.html', k: 'крайняя степень -기 그지없다 -기 짝이 없다 extreme geujieopda' },
        { t: 'Литературные обороты -(으)ㄹ라치면 · -(으)ㄹ세라', u: 'lesson_116_literary_eullachimyeon/index.html', k: 'литературные обороты -(으)ㄹ라치면 -(으)ㄹ세라 literary eullachimyeon' },
        { t: 'Притворяться -는 척하다', u: 'lesson_130_pretend_cheokhada/index.html', k: 'притворяться -는 척하다 pretend cheokhada' },
        { t: 'Сожаление -(으)ㄹ 걸 그랬다', u: 'lesson_131_regret_geol_geuraetda/index.html', k: 'сожаление -(으)ㄹ 그랬다 regret geol geuraetda' },
        { t: 'Степень действия -(으)ㄹ 정도로', u: 'lesson_132_degree_jeongdoro/index.html', k: 'степень действия -(으)ㄹ 정도로 degree jeongdoro' },
    ...
    var SEARCH_DATA_EN = [
        ...
        { t: 'Grammar Exercises', u: 'exercises.html', k: 'exercises drills practice answer keys workbook greetings food family home daily life topics' },
